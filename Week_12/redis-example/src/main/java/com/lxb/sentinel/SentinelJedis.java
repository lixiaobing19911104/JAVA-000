...
public class SentinelJedis {
    ...
    private static JedisSentinelPool POOL = createPool();
    ...
    private static JedisSentinelPool createPool() {
         ...
         */
        jedisPoolConfig.setMaxIdle(MAX_TOTAL);
        ...
        JedisSentinelPool jedisSentinelPool = new JedisSentinelPool(masterName, sentinels, jedisPoolConfig, TIMEOUT, null);
