...
@MapperScan(basePackages = {"com.lxb.rw.mapper"})
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.lxb.rw.entity");
    ...
    public AbstractRoutingDataSource roundRobinDataSouceProxy() {
        ...
        targetDataSources.put(DataSourceType.WRITE, dataSource);
        targetDataSources.put(DataSourceType.READ, readDataSources);
        //多个读数据库时
